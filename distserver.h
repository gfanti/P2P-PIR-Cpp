...
public:
    PercyDistServerParams(dbsize_t words_per_block, dbsize_t num_blocks,
	...
	PercyServerParams(words_per_block, num_blocks, tau, modulus, mode,
	...
	return PercyServerParams(new_wpb, new_nb, _tau, modulus, mode, be_byzantine, 
