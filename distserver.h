...
public:
	...
	PercyServerParams(words_per_block, num_blocks, max_unsynchronized, num_bins, tau, modulus, mode,
	...
	return PercyServerParams(new_wpb, new_nb, _tau, _max_unsynchronized, _num_bins, modulus, mode, be_byzantine, 
